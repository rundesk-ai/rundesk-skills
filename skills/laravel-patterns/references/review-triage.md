...
| `$request->all()` at persistence | Only validated, fillable fields should cross | [Validation](validation.md) |
| Request input passed to `unique()->ignore()` | The ignored value is not a trusted model or key | [Validation](validation.md) |
