---
name: vue-patterns
description: Use when building, reviewing, debugging, or refactoring Vue 3 or Nuxt applications, including components, reactivity, composables, Pinia, Vue Router, performance, SSR or hydration, and tests. It supplies source-backed defaults and community-solved traps that keep state flow, effects, and rendering predictable. Do not use for Vue 2 or a non-Vue project merely because it uses Vite.
---
