...
description: Use this skill when writing, reviewing, debugging, refactoring, organizing, documenting, or testing Python code, including module boundaries, names, public APIs, docstrings, comments, typing, errors, resources, concurrency, performance, version compatibility, or standard-library unittest. It supplies Python-specific design rules, paired good/bad patterns, and focused references for maintainable code.
---
