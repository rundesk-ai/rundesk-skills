...
`cpp-patterns`; this reference chooses evidence and explains what the tools can mislead you about.
...
| Memory, undefined-behavior, or race symptom | The sanitizer workflow in `cpp-patterns`, then its first complete report |
