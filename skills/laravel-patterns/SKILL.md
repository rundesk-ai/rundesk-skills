...
description: Laravel architecture patterns for routing, controllers, Eloquent, services, queues, events, caching, and API resources. Use when building or reviewing Laravel applications and APIs.
---
